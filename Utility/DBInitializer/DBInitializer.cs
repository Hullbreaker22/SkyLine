...
namespace SkyLine.Utility.DBInitializer
{
        ...
        public void Initialize()
        {
            try
            {
                ...
                if (_roleManager.Roles.IsNullOrEmpty())
                {
                    ...
                    {
                        Email = "SkyLine@travel.com",
                        EmailConfirmed = true,
                        UserName = "SuperAdmin",
                        Name = "Super Admin"
                    }, "Admin123@").GetAwaiter().GetResult();

                    var user = _userManager.FindByEmailAsync("SkyLine@travel.com").GetAwaiter().GetResult();
            ...
            catch(Exception ex)
            {
                ...
                _logger.LogError("We are Using the Local Server Be Careful! (.)");
            }
        }
    }
}
